    ...
    <section className="hero-section">
      <motion.div className="hero-content" variants={container} initial="hidden" animate="show">
        ...
        <motion.p className="hero-subtitle" variants={item}>
          Full Stack Developer · MERN · AI · Data Analytics
        </motion.p>

        <motion.p className="hero-description" variants={item}>
          I design and build scalable web applications with clean code, thoughtful UX,
          and a strong interest in AI-powered features.
        </motion.p>
